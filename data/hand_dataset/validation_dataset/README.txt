...
- Validation dataset (all the images with hand bounding-box annotations).
...
PWD/validation_data: Directory containing validation data.

PWD/validation_data/images: Directory containing validation data images.

PWD/validation_data/annotations: Annotations files for the validation dataset.

countvaldata.m : Matlab function for validation data statistics.
