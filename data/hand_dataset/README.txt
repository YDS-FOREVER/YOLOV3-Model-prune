...
- Evaluation code for test set of the hand dataset.
- Code to visualize annotations.
- Code to give statistics of data in each of the dataset.

Let PWD be the directory of the hand-dataset, then the structure of the containts is as follows:

PWD/training_data (or validation_data or test_data): Directory containing training (or validation or test) data.

PWD/training_data/images: Directory containing training (or validation or test) data images.

PWD/training_data/annotations: Annotations files for the training (or validation or test) dataset.

PWD/evaluation_code: Evaluation code for the hand dataset.
